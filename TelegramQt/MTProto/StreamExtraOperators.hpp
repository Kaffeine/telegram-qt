...
TELEGRAMQT_INTERNAL_EXPORT Stream &operator<<(Stream &stream, const TLCdnFileHash &cdnFileHashValue);
...
TELEGRAMQT_INTERNAL_EXPORT Stream &operator<<(Stream &stream, const TLDisabledFeature &disabledFeatureValue);
...
TELEGRAMQT_INTERNAL_EXPORT Stream &operator<<(Stream &stream, const TLInputPeerNotifyEvents &inputPeerNotifyEventsValue);
...
TELEGRAMQT_INTERNAL_EXPORT Stream &operator<<(Stream &stream, const TLPeerNotifyEvents &peerNotifyEventsValue);
