...
template Stream &Stream::operator>>(QVector<qint32> &v);
template Stream &Stream::operator>>(QVector<quint32> &v);
template Stream &Stream::operator>>(QVector<qint64> &v);
template Stream &Stream::operator>>(QVector<quint64> &v);
template Stream &Stream::operator>>(QVector<QString> &v);

template Stream &Stream::operator<<(const QVector<qint32> &v);
template Stream &Stream::operator<<(const QVector<quint32> &v);
template Stream &Stream::operator<<(const QVector<qint64> &v);
template Stream &Stream::operator<<(const QVector<quint64> &v);
template Stream &Stream::operator<<(const QVector<QString> &v);
...
template Stream &Stream::operator>>(QVector<TLChannelAdminLogEvent> &v);
template Stream &Stream::operator>>(QVector<TLTopPeerCategoryPeers> &v);
template Stream &Stream::operator>>(QVector<TLPopularContact> &v);
template Stream &Stream::operator>>(QVector<TLCdnPublicKey> &v);
template Stream &Stream::operator>>(QVector<TLRecentMeUrl> &v);
template Stream &Stream::operator>>(QVector<TLStickerSetCovered> &v);
template Stream &Stream::operator>>(QVector<TLHighScore> &v);
template Stream &Stream::operator>>(QVector<TLFutureSalt> &v);
template Stream &Stream::operator>>(QVector<TLRichText> &v);
template Stream &Stream::operator>>(QVector<TLLabeledPrice> &v);
template Stream &Stream::operator>>(QVector<TLTopPeer> &v);
template Stream &Stream::operator>>(QVector<TLIpPort> &v);
template Stream &Stream::operator>>(QVector<TLLangPackString> &v);
template Stream &Stream::operator>>(QVector<TLShippingOption> &v);
template Stream &Stream::operator>>(QVector<TLInputDocument> &v);
template Stream &Stream::operator>>(QVector<TLPageBlock> &v);
template Stream &Stream::operator>>(QVector<TLPhoneConnection> &v);
template Stream &Stream::operator>>(QVector<TLInputStickerSetItem> &v);
template Stream &Stream::operator>>(QVector<TLSecureValue> &v);
template Stream &Stream::operator>>(QVector<TLSecureRequiredType> &v);
template Stream &Stream::operator>>(QVector<TLSecureValueError> &v);
template Stream &Stream::operator>>(QVector<TLWebAuthorization> &v);
template Stream &Stream::operator>>(QVector<TLSecureFile> &v);
template Stream &Stream::operator>>(QVector<TLSavedContact> &v);
template Stream &Stream::operator>>(QVector<TLJSONValue> &v);
template Stream &Stream::operator>>(QVector<TLJSONObjectValue> &v);
template Stream &Stream::operator>>(QVector<TLDialogPeer> &v);
template Stream &Stream::operator>>(QVector<TLFileHash> &v);
template Stream &Stream::operator>>(QVector<TLAccessPointRule> &v);
template Stream &Stream::operator>>(QVector<TLInputSecureFile> &v);
template Stream &Stream::operator>>(QVector<TLPageTableCell> &v);
template Stream &Stream::operator>>(QVector<TLPollAnswer> &v);
template Stream &Stream::operator>>(QVector<TLPollAnswerVoters> &v);
template Stream &Stream::operator>>(QVector<TLSecureValueType> &v);
template Stream &Stream::operator>>(QVector<TLPageListItem> &v);
template Stream &Stream::operator>>(QVector<TLPageTableRow> &v);
template Stream &Stream::operator>>(QVector<TLPageListOrderedItem> &v);
template Stream &Stream::operator>>(QVector<TLPageRelatedArticle> &v);
template Stream &Stream::operator>>(QVector<TLSecureValueHash> &v);
template Stream &Stream::operator>>(QVector<TLInputMessage> &v);
template Stream &Stream::operator>>(QVector<TLInputDialogPeer> &v);
template Stream &Stream::operator>>(QVector<TLInputSingleMedia> &v);
// End of generated vector read templates instancing

// Generated vector write templates instancing
template Stream &Stream::operator<<(const QVector<TLInputPrivacyRule> &v);
template Stream &Stream::operator<<(const QVector<TLInputChannel> &v);
template Stream &Stream::operator<<(const QVector<TLInputUser> &v);
template Stream &Stream::operator<<(const QVector<TLInputContact> &v);
template Stream &Stream::operator<<(const QVector<TLInputAppEvent> &v);
template Stream &Stream::operator<<(const QVector<TLMessageEntity> &v);
template Stream &Stream::operator<<(const QVector<TLInputBotInlineResult> &v);
template Stream &Stream::operator<<(const QVector<TLInputPhoto> &v);
template Stream &Stream::operator<<(const QVector<TLDocumentAttribute> &v);
template Stream &Stream::operator<<(const QVector<TLKeyboardButtonRow> &v);
template Stream &Stream::operator<<(const QVector<TLMessageRange> &v);
template Stream &Stream::operator<<(const QVector<TLKeyboardButton> &v);
template Stream &Stream::operator<<(const QVector<TLShippingOption> &v);
template Stream &Stream::operator<<(const QVector<TLInputStickerSetItem> &v);
template Stream &Stream::operator<<(const QVector<TLInputDocument> &v);
template Stream &Stream::operator<<(const QVector<TLLabeledPrice> &v);
template Stream &Stream::operator<<(const QVector<TLSecureValueHash> &v);
template Stream &Stream::operator<<(const QVector<TLSecureValueType> &v);
template Stream &Stream::operator<<(const QVector<TLInputMessage> &v);
template Stream &Stream::operator<<(const QVector<TLInputDialogPeer> &v);
template Stream &Stream::operator<<(const QVector<TLInputSingleMedia> &v);
template Stream &Stream::operator<<(const QVector<TLSecureValueError> &v);
template Stream &Stream::operator<<(const QVector<TLInputSecureFile> &v);
template Stream &Stream::operator<<(const QVector<TLJSONValue> &v);
template Stream &Stream::operator<<(const QVector<TLJSONObjectValue> &v);
template Stream &Stream::operator<<(const QVector<TLPollAnswer> &v);
