...
template Stream &Stream::operator>>(QVector<TLCdnFileHash> &v);
...
template Stream &Stream::operator>>(QVector<TLInputPeer> &v);
...
template Stream &Stream::operator<<(const QVector<TLInputPeer> &v);
