...
struct TELEGRAMQT_INTERNAL_EXPORT TLJSONValue {
    ...
    QString stringValue;
    QVector<TLJSONValue*> jSONValueVector;
    QVector<TLJSONObjectValue> jSONObjectValueVector;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLHelpConfigSimple {
    ...
    quint32 date = 0;
    quint32 expires = 0;
    QVector<TLAccessPointRule> rules;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLInputSecureValue {
    ...
    QVector<TLInputSecureFile> translation;
    QVector<TLInputSecureFile> files;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLPollResults {
    ...
    quint32 flags = 0;
    QVector<TLPollAnswerVoters> results;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLSecureRequiredType {
    ...
    quint32 flags = 0;
    TLSecureValueType type;
    QVector<TLSecureRequiredType*> types;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLSecureValue {
    ...
    TLSecureFile selfie;
    QVector<TLSecureFile> translation;
    QVector<TLSecureFile> files;
    TLSecurePlainData plainData;
    QByteArray hash;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLSecureValueError {
    ...
    QVector<QByteArray> byteArrayFileHashVector;
    QByteArray hash;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLAccountAuthorizationForm {
    ...
    quint32 flags = 0;
    QVector<TLSecureRequiredType*> requiredTypes;
    QVector<TLSecureValue> values;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLAccountWebAuthorizations {
    ...
    QVector<TLWebAuthorization> authorizations;
    QVector<TLUser> users;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLPageBlock {
    ...
    QString language;
    QString name;
    QVector<TLPageListItem> pageListItemItemsVector;
    ...
    quint64 audioId = 0;
    TLRichTextPtr title;
    QVector<TLPageTableRow> rows;
    QVector<TLPageListOrderedItem> pageListOrderedItemItemsVector;
    QVector<TLPageRelatedArticle> articles;
    TLGeoPoint geo;
    quint32 zoom = 0;
...
struct TELEGRAMQT_INTERNAL_EXPORT TLUpdate {
    ...
    QVector<TLDialogPeer> dialogPeerOrderVector;
    TLDataJSON jSONData;
    quint32 timeout = 0;
    QByteArray payload;
    TLPostAddress shippingAddress;
