...
template Stream &Stream::operator<<(const QVector<TLDialogPeer> &v);
template Stream &Stream::operator<<(const QVector<TLFileHash> &v);
template Stream &Stream::operator<<(const QVector<TLSecureValue> &v);
