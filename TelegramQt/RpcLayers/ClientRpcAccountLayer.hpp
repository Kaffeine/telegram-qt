...
public:
    ...
    using PendingSecureValueVector = PendingRpcResult<QVector<TLSecureValue> *>;
    ...
    PendingBool *acceptAuthorization(quint32 botId, const QString &scope, const QString &publicKey, const QVector<TLSecureValueHash> &valueHashes, const TLSecureCredentialsEncrypted &credentials);
    ...
    PendingBool *deleteSecureValue(const QVector<TLSecureValueType> &types);
    ...
    PendingSecureValueVector *getSecureValue(const QVector<TLSecureValueType> &types);
    ...
    PendingBool *registerDevice(quint32 tokenType, const QString &token, bool appSandbox, const QByteArray &secret, const QVector<quint32> &otherUids);
    ...
    PendingBool *unregisterDevice(quint32 tokenType, const QString &token, const QVector<quint32> &otherUids);
