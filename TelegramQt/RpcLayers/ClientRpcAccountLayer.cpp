...
AccountRpcLayer::PendingBool *AccountRpcLayer::acceptAuthorization(quint32 botId, const QString &scope, const QString &publicKey, const QVector<TLSecureValueHash> &valueHashes, const TLSecureCredentialsEncrypted &credentials)
{
...
AccountRpcLayer::PendingBool *AccountRpcLayer::deleteSecureValue(const QVector<TLSecureValueType> &types)
{
...
AccountRpcLayer::PendingSecureValueVector *AccountRpcLayer::getSecureValue(const QVector<TLSecureValueType> &types)
{
    qCDebug(c_clientRpcAccountCategory) << Q_FUNC_INFO << types;
    MTProto::Stream outputStream(MTProto::Stream::WriteOnly);
...
AccountRpcLayer::PendingBool *AccountRpcLayer::registerDevice(quint32 tokenType, const QString &token, bool appSandbox, const QByteArray &secret, const QVector<quint32> &otherUids)
{
...
AccountRpcLayer::PendingBool *AccountRpcLayer::unregisterDevice(quint32 tokenType, const QString &token, const QVector<quint32> &otherUids)
{
