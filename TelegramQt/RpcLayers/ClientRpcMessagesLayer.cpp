...
MessagesRpcLayer::PendingBool *MessagesRpcLayer::editInlineBotMessage(quint32 flags, const TLInputBotInlineMessageID &id, const QString &message, const TLInputMedia &media, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities)
{
...
MessagesRpcLayer::PendingUpdates *MessagesRpcLayer::editMessage(quint32 flags, const TLInputPeer &peer, quint32 id, const QString &message, const TLInputMedia &media, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities)
{
...
MessagesRpcLayer::PendingMessagesMessages *MessagesRpcLayer::getMessages(const QVector<TLInputMessage> &id)
{
    qCDebug(c_clientRpcMessagesCategory) << Q_FUNC_INFO << id;
    MTProto::Stream outputStream(MTProto::Stream::WriteOnly);
...
MessagesRpcLayer::PendingMessagesPeerDialogs *MessagesRpcLayer::getPeerDialogs(const QVector<TLInputDialogPeer> &peers)
{
...
MessagesRpcLayer::PendingMessageMedia *MessagesRpcLayer::getWebPagePreview(quint32 flags, const QString &message, const QVector<TLMessageEntity> &entities)
{
...
MessagesRpcLayer::PendingBool *MessagesRpcLayer::reorderPinnedDialogs(quint32 flags, const QVector<TLInputDialogPeer> &order)
{
...
MessagesRpcLayer::PendingBool *MessagesRpcLayer::report(const TLInputPeer &peer, const QVector<quint32> &id, const TLReportReason &reason)
{
...
MessagesRpcLayer::PendingUpdates *MessagesRpcLayer::sendMedia(quint32 flags, const TLInputPeer &peer, quint32 replyToMsgId, const TLInputMedia &media, const QString &message, quint64 randomId, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities)
{
...
MessagesRpcLayer::PendingUpdates *MessagesRpcLayer::sendMultiMedia(quint32 flags, const TLInputPeer &peer, quint32 replyToMsgId, const QVector<TLInputSingleMedia> &multiMedia)
{
...
MessagesRpcLayer::PendingUpdates *MessagesRpcLayer::sendVote(const TLInputPeer &peer, quint32 msgId, const QVector<QByteArray> &options)
{
