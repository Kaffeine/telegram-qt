...
public:
    ...
    PendingBool *editInlineBotMessage(quint32 flags, const TLInputBotInlineMessageID &id, const QString &message, const TLReplyMarkup &replyMarkup, const TLVector<TLMessageEntity> &entities, const TLInputGeoPoint &geoPoint);
    PendingUpdates *editMessage(quint32 flags, const TLInputPeer &peer, quint32 id, const QString &message, const TLReplyMarkup &replyMarkup, const TLVector<TLMessageEntity> &entities, const TLInputGeoPoint &geoPoint);
    ...
    PendingMessagesMessages *getMessages(const TLVector<quint32> &id);
    PendingQuint32Vector *getMessagesViews(const TLInputPeer &peer, const TLVector<quint32> &id, bool increment);
    PendingMessagesPeerDialogs *getPeerDialogs(const TLVector<TLInputPeer> &peers);
    ...
    PendingBool *reorderPinnedDialogs(quint32 flags, const TLVector<TLInputPeer> &order);
