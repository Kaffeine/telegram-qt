...
public:
    ...
    using PendingDialogPeerVector = PendingRpcResult<QVector<TLDialogPeer> *>;
    ...
    using PendingMessageRangeVector = PendingRpcResult<QVector<TLMessageRange> *>;
    ...
    PendingBool *editInlineBotMessage(quint32 flags, const TLInputBotInlineMessageID &id, const QString &message, const TLInputMedia &media, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities);
    PendingUpdates *editMessage(quint32 flags, const TLInputPeer &peer, quint32 id, const QString &message, const TLInputMedia &media, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities);
    ...
    PendingMessagesMessages *getMessages(const QVector<TLInputMessage> &id);
    ...
    PendingMessagesPeerDialogs *getPeerDialogs(const QVector<TLInputDialogPeer> &peers);
    ...
    PendingMessageMedia *getWebPagePreview(quint32 flags, const QString &message, const QVector<TLMessageEntity> &entities);
    ...
    PendingBool *reorderPinnedDialogs(quint32 flags, const QVector<TLInputDialogPeer> &order);
    PendingBool *reorderStickerSets(quint32 flags, const QVector<quint64> &order);
    PendingBool *report(const TLInputPeer &peer, const QVector<quint32> &id, const TLReportReason &reason);
    ...
    PendingUpdates *sendMedia(quint32 flags, const TLInputPeer &peer, quint32 replyToMsgId, const TLInputMedia &media, const QString &message, quint64 randomId, const TLReplyMarkup &replyMarkup, const QVector<TLMessageEntity> &entities);
    ...
    PendingUpdates *sendMultiMedia(quint32 flags, const TLInputPeer &peer, quint32 replyToMsgId, const QVector<TLInputSingleMedia> &multiMedia);
    PendingUpdates *sendScreenshotNotification(const TLInputPeer &peer, quint32 replyToMsgId, quint64 randomId);
    PendingUpdates *sendVote(const TLInputPeer &peer, quint32 msgId, const QVector<QByteArray> &options);
