...
TELEGRAMQT_INTERNAL_EXPORT QDebug operator<<(QDebug d, const TLCdnFileHash &cdnFileHashValue);
...
TELEGRAMQT_INTERNAL_EXPORT QDebug operator<<(QDebug d, const TLDisabledFeature &disabledFeatureValue);
...
TELEGRAMQT_INTERNAL_EXPORT QDebug operator<<(QDebug d, const TLInputPeerNotifyEvents &inputPeerNotifyEventsValue);
...
TELEGRAMQT_INTERNAL_EXPORT QDebug operator<<(QDebug d, const TLPeerNotifyEvents &peerNotifyEventsValue);
