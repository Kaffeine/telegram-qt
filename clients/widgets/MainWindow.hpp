...
protected slots:
    ...
    void onAuthSignErrorReceived(Telegram::Namespace::AuthenticationError errorCode, const QByteArray &errorMessage);
    void updateContactList();
    void onMessageReceived(const Telegram::Peer peer, quint32 messageId);
    void onContactChatMessageActionChanged(quint32 chatId, quint32 userId, Telegram::MessageAction action);
    void onContactMessageActionChanged(quint32 userId, Telegram::MessageAction action);
...
#endif
    void onUserNameStatusUpdated(const QString &userName, Telegram::Namespace::UserNameStatus status);
...
private:
    ...
    QMap<Telegram::Client::FileOperation *, Telegram::Peer> m_uploadingRequests;
